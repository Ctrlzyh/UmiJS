      ...
      children:
        <div>
          ...
          <div className={styles.studyView}>
            <img className={styles.studyLogo} src={require('../../assets/study.png')}></img>
            <div className={styles.studyLeft}>实验模块1</div>
            <div className={styles.rightPanel}>
              <div className={styles.rightPanelTop}>
                <img style={{ marginRight: 5 }} src={require('../../assets/star.png')} />
                <img style={{ marginRight: 5 }} src={require('../../assets/star.png')} />
                <img style={{ marginRight: 5 }} src={require('../../assets/star.png')} />
                <img style={{ marginRight: 5 }} src={require('../../assets/star.png')} />
                <img style={{ marginRight: 10 }} src={require('../../assets/star.png')} />
                <span style={{
                  width: 62,
                  color: '#000',
                  fontSize: 16,
    ...
    >
      <div className={styles.container}>
        ...
        <div className={styles.bottomView}>
          <div className={styles.bottomViewContent}>
            <div>
